...
export default function Portfolio() {
  ...
  const projects = [
    {
      ...
      githubUrl: "https://github.com/Toad-Sage-Jiraya",
      highlights: [
...

    {
        ...
        description: "Developed a malware detection model achieving 93%+ accuracy",
        tech: ["Random Forest", "Logistic Regression", "Decision Tree"],
        status: "Completed",
        impact: "93%+ detection accuracy",
        date: "Feb 2024 – Mar 2024",
        githubUrl: "https://github.com/Toad-Sage-Jiraya",
        highlights: [
          "Designed for large data handling in cybersecurity systems",
          "Implemented efficient feature extraction"
        ]
      },
      {
        title: "Stock Price Prediction Model",
        description: "Forecasted stock prices using time-series data and LSTM-based techniques",
        tech: ["LSTM Neural Network", "Python", "Pandas", "NumPy", "Keras", "Sklearn"],
        status: "Completed",
        impact: "Improved model performance using MinMaxScaler",
        date: "June 2024 – Aug 2024",
        githubUrl: "https://github.com/Toad-Sage-Jiraya",
        highlights: [
          "Developed LSTM-based forecasting model",
          "Enhanced time-series accuracy through scaling"
        ]
      },
      {
        title: "Sorting Algorithm Visualizer",
        description: "Created an interactive visualizer for Bubble, Merge, Quick, and Insertion Sort",
        tech: ["HTML", "CSS", "JavaScript"],
        status: "Completed",
        impact: "Educational tool with dynamic visualization and user interaction",
        date: "June 2024 – July 2024",
        githubUrl: "https://github.com/Toad-Sage-Jiraya",
        highlights: [
          "Enabled users to control array size and speed",
  ...
  const certificationsAndAchievements = [
    {
      icon: Award,
      title: "GoogleData Analytics Certificate",
      description: "Professional certification in data analytics",
      type: "certification",
      link: "https://www.coursera.org/account/accomplishments/professional-cert/L0UAEV9NTIDJ",
    ...
    },
    {
      ...
      type: "certification",
      link: "https://www.coursera.org/account/accomplishments/professional-cert/UU83P8CTJMXS",
      issuer: "Google via Coursera",
    },
    {
      icon: Code,
  ...
  const titles = ["Manish", "Developer", "Problem Solver", "Tech Enthusiast"]
          ...
          >
            ...
            >
              <Button
                ...
                onClick={() => window.open("mailto:manishmehta4141@gmail.com")}
              >
                <span
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  link.href = "/resume/MANISH-RESUME.pdf"
                  link.download = "MANISH-RESUME.pdf"
                  link.click()
                }}
              >
                <span
                    ...
                    <CardContent className="p-4 sm:p-6">
                      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-4">
                        <div>
                          ...
                          Teaching and Research Training Program
                          </h3>
                          <p
                            className={`${
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          >
                            <li>•  Trained by excellent faculties to demonstrate teaching abilities, research innova
                            tion, and leadership skills.</li>
                          </ul>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {[ "GenAI", "MS Excel", "PowerPoint", "MS Word", "Notebook LM", "SLM Creation"].map((tech) => (
                              <Badge
                                key={tech}
                                variant="secondary"
                                className={`text-xs ${
                    ...
                    <CardContent className="p-4 sm:p-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {["React.js", "HTML", "CSS", "JavaScript"].map(
                              (tech) => (
                                <Badge
                                  key={tech}
                                  variant="secondary"
                        ...
                        >
                          ...
                          Improved web development skills; experience in teamwork and feature deploy
                          ment.
                          </p>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              >
                ...
                <span className="relative z-10">manishmehta4141@gmail.com</span>
              </Button>
              <Button
                size="lg"
                className={`${
                ...
                onClick={() => window.open("tel:+918755647578")}
              >
                <span
                  className={`absolute inset-0 ${
                    isDayMode ? "bg-orange-500/20" : "bg-purple-600/20"
                ...
                <span className="relative z-10">+91 87556475781</span>
              </Button>
            </div>

            <div className="flex justify-center space-x-6">
              <motion.a
                href="https://github.com/Toad-Sage-Jiraya"
                target="_blank"
                rel="noopener noreferrer"
                className="group"
                whileHover={{ scale: 1.1 }}
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 text-center">
          <p className={`text-sm lg:text-base ${isDayMode ? "text-gray-600" : "text-gray-400"}`}>
            &copy; 2024 Manish Mehta. Crafted with passion and precision.
          </p>
        </div>
      </footer>
    </div>
